"""updated vehicle obervation model

Revision ID: 961d2c6f343b
Revises:
Create Date: 2025-07-25 06:38:49.430044
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "orientation",
            postgresql.ENUM("FRONT", "REAR", name="vehicle_orientation"),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_vehicle_observations_plate_hash",
        "vehicle_observations",
        ["plate_hash"],
        unique=False,
        schema="ingestion_schema",
    ...
    op.create_index(
        "idx_vehicle_observations_timestamp",
        "vehicle_observations",
        ["timestamp"],
        unique=False,
        schema="ingestion_schema",
